...
<template>
  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item>
          <a-input type="hidden" v-decorator="['userId', {rules: [{required: false}]}]" />
        </a-form-item>
        <a-form-item label="用户名" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input :disabled="!isAddUser" v-decorator="['userName', {rules: [{required: true}]}]" />
        </a-form-item>

        <a-form-item label="密码" v-if="isAddUser" :labelCol="labelCol" :wrapperCol="wrapperCol">
        ...
        <a-form-item label="所属角色" :labelCol="labelCol" :wrapperCol="wrapperCol" v-if="!isAdmin">
          <a-select mode="multiple" :value="roleIds" @change="onRoleChange">
            <a-select-option v-for="role in roles" :key="role.roleId">{{ role.roleName }}</a-select-option>
          </a-select>
        </a-form-item>
        ...
        <a-form-item label="所属岗位" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select mode="multiple" :value="postIds" @change="onPostChange">
            <a-select-option v-for="post in posts" :key="post.postId">{{ post.postName }}</a-select-option>
          </a-select>
        </a-form-item>
      </a-form>
    </a-spin>
